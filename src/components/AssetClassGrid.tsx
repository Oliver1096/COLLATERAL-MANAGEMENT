        ...
        {assetClassItems.map((item) => {
          ...
          return (
            <a
              key={item.title}
              href={item.href}
              className="group min-h-[74px] rounded-xl border border-white/10 bg-white/[0.035] p-3 transition hover:-translate-y-0.5 hover:border-emerald-300/35 hover:bg-emerald-400/10 hover:shadow-[0_14px_35px_rgba(0,0,0,0.22)]"
            >
              <div className="flex h-7 w-7 items-center justify-center rounded-lg border border-emerald-400/20 bg-emerald-400/10 text-emerald-300">
