...
export function TopSearch() {
  return (
    <header className="sticky top-0 z-30 border-b border-white/10 bg-[#020706]/86 px-3 py-2 backdrop-blur-xl sm:px-3 lg:ml-36">
      <div className="mx-auto flex max-w-[1400px] items-center gap-4">
        ...
        <div className="relative mx-auto max-w-[455px] flex-1">
          <Search className="pointer-events-none absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-500" />
          <input
            className="h-9 w-full rounded-lg border border-white/10 bg-white/[0.035] pl-11 pr-12 text-xs text-white outline-none transition placeholder:text-slate-500 focus:border-emerald-300/40 focus:bg-white/[0.06]"
